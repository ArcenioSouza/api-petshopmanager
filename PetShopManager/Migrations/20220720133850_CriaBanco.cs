...
namespace PetShopManager.Migrations
{
    public partial class CriaBanco : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //Animal
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`animais` (`Id`, `Nome`, `ClienteId`, `Sexo`, `PesoAtual`, `AlturaAtual`, `Raca`, `TempoDeVida`, `Temperamento`, `PesoMedio`, `AlturaMedia`, `IsActive`) VALUES ('1', 'Dob', '1', 'Fêmea', '10', '55', 'American Bulldog', '10 - 12 years', 'Friendly, Assertive, Energetic, Loyal, Gentle, Confident, Dominant', '27 - 54', '56 - 69', '1')");
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`animais` (`Id`, `Nome`, `ClienteId`, `Sexo`, `PesoAtual`, `AlturaAtual`, `Raca`, `TempoDeVida`, `Temperamento`, `PesoMedio`, `AlturaMedia`, `IsActive`) VALUES ('2', 'Rufus', '2', 'Macho', '10', '55', 'American Bulldog', '10 - 12 years', 'Friendly, Assertive, Energetic, Loyal, Gentle, Confident, Dominant', '27 - 54', '56 - 69', '1')");
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`animais` (`Id`, `Nome`, `ClienteId`, `Sexo`, `PesoAtual`, `AlturaAtual`, `Raca`, `TempoDeVida`, `Temperamento`, `PesoMedio`, `AlturaMedia`, `IsActive`) VALUES ('3', 'Feroz', '3', 'Macho', '10', '55', 'American Bulldog', '10 - 12 years', 'Friendly, Assertive, Energetic, Loyal, Gentle, Confident, Dominant', '27 - 54', '56 - 69', '1')");

            //Servico
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`servicos` (`Id`, `Tipo`, `Valor`, `IsActive`) VALUES ('1', 'Vacinação', '40', '1')");
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`servicos` (`Id`, `Tipo`, `Valor`, `IsActive`) VALUES ('2', 'Banho e Tosa', '60', '1')");
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`servicos` (`Id`, `Tipo`, `Valor`, `IsActive`) VALUES ('3', 'Consulta', '80', '1')");

            //Atendimento
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`atendimentos` (`Id`, `ServicoId`, `ClienteId`, `FuncionarioId`, `AnimalId`, `PesoDoAnimalAtualizado`, `AlturaDoAnimalAtualizado`, `DataAtendimento`, `Diagnostico`, `Observacoes`) VALUES ('1', '1', '1', '1', '1',  '0', '0', '2022-07-10 00:00:00.000000', 'Vacinação em dia', 'Próxima vacina daqui a dois meses')");
            migrationBuilder.Sql(@"INSERT INTO `petshop`.`atendimentos` (`Id`, `ServicoId`, `ClienteId`, `FuncionarioId`, `AnimalId`, `PesoDoAnimalAtualizado`, `AlturaDoAnimalAtualizado`, `DataAtendimento`, `Diagnostico`, `Observacoes`) VALUES ('2', '2', '2', '4', '2',  '0', '0', '2022-07-12 00:00:00.000000', 'Foram encontrados alguns nó, mas sem dificuldade para tira-lo', 'null')");
